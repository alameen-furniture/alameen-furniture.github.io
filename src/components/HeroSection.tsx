  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto pt-16">
        ...
        <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-4 leading-tight tracking-tight">
          Custom Sofa & Bed Maker in{" "}
          <span className="text-primary italic">Kolkata</span>
        </h1>

        <p className="text-muted-foreground text-base sm:text-lg max-w-xl mx-auto mb-8 font-light">
          Premium handcrafted furniture built to your style. Starting at just ₹4,999.
        </p>
