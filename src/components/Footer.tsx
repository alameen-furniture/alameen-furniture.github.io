        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-4">
              Kolkata's trusted custom furniture manufacturer. Premium sofas,
              designer beds, wardrobes & complete home interiors — crafted to
              perfection.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a
                  href="mailto:akbarkhan891072@gmail.com"
                  className="flex items-start gap-3 text-sm text-muted-foreground hover:text-primary transition-colors group"
                >
              ...
              <li className="flex items-start gap-3 text-sm text-muted-foreground">
                ...
                <span>
                  36, 4/3 Behari Mondal Road, Shanti Pally, Ramlal Bazar, Haltu,
      ...
      <div className="border-t border-border">
        ...
        <div className="max-w-6xl mx-auto px-6 pb-4">
          <p className="text-xs text-muted-foreground text-center">
            Custom Furniture Manufacturer in Kolkata · Sofas · Beds · Wardrobes
            · Home Interiors · Serving All Areas of Kolkata
          </p>
        </div>
      </div>
